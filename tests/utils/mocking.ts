...
import { Path, pathToString } from "./path-to-string";
 ...
 */
function mockGlobal<T extends object>(name: keyof typeof globalThis, mockedProps: DeepPartialObject<T> = {}, allowUndefinedAccess: boolean = false) {
